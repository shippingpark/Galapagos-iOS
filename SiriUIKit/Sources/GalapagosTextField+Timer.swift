...
public final class GalapagosTextField_Timer: UIView {
  ...
  fileprivate lazy var textField: UITextField = {
    ...
    textField.textColor = SiriUIKitAsset.black제목DisplayHeadingBody.color
    return textField
  }()
  ...
  // MARK: - Properties
  typealias TextFieldWithTimerUISet = (borderColor: UIColor, textFieldBackgroundColor: UIColor, textFieldTextColor: UIColor, isUserInteractive: Bool)
...
extension GalapagosTextField_Timer{
  ...
  public enum TextFieldWithTimerType {
    ...
    var timerColor: UIColor {
      switch self {
      case .def:
        return SiriUIKitAsset.white기본화이트.color
      case .focus:
    ...
    var UISet: TextFieldWithTimerUISet {
      ...
      case .def:
        return TextFieldWithTimerUISet(
          ...
          textFieldBackgroundColor: SiriUIKitAsset.white기본화이트.color,
          textFieldTextColor: SiriUIKitAsset.gray1본문Body.color,
