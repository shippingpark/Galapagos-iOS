...
extension GalapagosErrorMessage {
	...
	public enum GalapagosErrorMessageType {
		...
		var UISet: GalapagosErrorMessageUISet {
			...
			case .error:
				return (
					errorMessageColor: SiriUIKitAsset.redErrorText.color,
					accessoryImage: nil
				)
			case .success:
				return (
					errorMessageColor: SiriUIKitAsset.green.color,
			...
			case .disabled:
				return (
					errorMessageColor: SiriUIKitAsset.gray5DisableText2.color,
