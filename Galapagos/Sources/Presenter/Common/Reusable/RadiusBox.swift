...
class RadiusBoxView: UIView {
  ...
  private func configureStyleSet() {
    ...
    case .line:
      ...
      self.layer.shadowColor = GalapagosAsset.whiteDefaultWhite.color.cgColor
    case .shadow:
      self.layer.shadowColor = GalapagosAsset.blackDisplayHeadingBody.color.withAlphaComponent(0.12).cgColor
