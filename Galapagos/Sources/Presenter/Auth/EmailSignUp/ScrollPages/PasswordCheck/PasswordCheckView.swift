...
final class PasswordCheckView: UIView {
    ...
    private lazy var passwordErrorStackView: [UIStackView] = {
        let stackViewFirst = UIStackView(arrangedSubviews: [passwordErrorCells[0],
    ...
    private func bind(){
        ...
        let input = PasswordCheckViewModel.Input(password: passwordTextField.rx.text.orEmpty.asObservable(),
